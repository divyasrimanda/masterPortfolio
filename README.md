...
- At the bottom of this file you will see the below code:
  ...
  - You need to change the name from `blackTheme` to whatever theme you want to set your website to
  - You can define new theme similarly as other themes and you can assign name of that new defined theme to `blackTheme`
